...
import { profilesRoutes } from "./routes/index.js";

export async function buildApp() {
  EventBus.init({ serviceName: "profiles", url: process.env.NATS_URL });
  ...
  await app.register(profilesRoutes, { prefix: "/api/profiles/v1" });
